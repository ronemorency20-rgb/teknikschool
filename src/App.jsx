...
function Root() {
  ...
  // Public shareable lesson preview — /#/preview/<chapterId> — works
  // without being logged in, so students can share it outside the app.
  if (route.startsWith("/preview/")) {
    const chapterId = route.slice("/preview/".length);
    return <PreviewPage chapterId={chapterId} />;
  }
