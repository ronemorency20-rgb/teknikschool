...
export function Box3DIcon({ size = 18, color = "currentColor" }) {
  return (
    <svg {...base(size, color)}>
...
export function KeyIcon({ size = 18, color = "currentColor" }) {
  return (
    <svg {...base(size, color)}>
...
export function BanIcon({ size = 18, color = "currentColor" }) {
  return (
    <svg {...base(size, color)}>
      <circle cx="12" cy="12" r="10" />
...
export function LightbulbIcon({ size = 18, color = "currentColor" }) {
  return (
    <svg {...base(size, color)}>
...
export function AlertTriangleIcon({ size = 18, color = "currentColor" }) {
  return (
    <svg {...base(size, color)}>
...
export function ActivityIcon({ size = 18, color = "currentColor" }) {
  return (
    <svg {...base(size, color)}>
...
export function HelpCircleIcon({ size = 18, color = "currentColor" }) {
  return (
    <svg {...base(size, color)}>
      <circle cx="12" cy="12" r="10" />
...
export function ChevronLeftIcon({ size = 18, color = "currentColor" }) {
  return (
    <svg {...base(size, color)}>
...
export function EyeOpenIcon({ size = 18, color = "currentColor" }) {
  return (
    <svg {...base(size, color)}>
      <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
      <circle cx="12" cy="12" r="3" />
