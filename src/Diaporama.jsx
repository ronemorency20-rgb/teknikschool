...
export default function Diaporama() {
  ...
  return (
    <div className="diaporama-hero" style={{ position: "relative", width: "100%", overflow: "hidden" }}>
      <style>{`.diaporama-hero { height: 150px; } @media (min-width: 640px) { .diaporama-hero { height: 220px; } }`}</style>
      {slide.link_url ? (
