...
export default function AuthScreen({ onGoForgot, onGoApply, onGoFinalize }) {
  ...
  return (
    <div className="auth-screen" style={{ background: "#FFFFFF", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans',sans-serif", padding: "max(16px, env(safe-area-inset-top)) max(16px, env(safe-area-inset-right)) max(16px, env(safe-area-inset-bottom)) max(16px, env(safe-area-inset-left))", boxSizing: "border-box" }}>
      <style>{`.auth-screen { min-height: 100vh; min-height: 100dvh; }`}</style>
      <link href={FONTS} rel="stylesheet" />
      <div style={{ background: "#fff", border: "1px solid #E2E5EB", borderRadius: 20, padding: "clamp(24px, 6vw, 44px)", width: "100%", maxWidth: 420, boxShadow: "0 20px 60px rgba(20,20,40,0.08)", boxSizing: "border-box" }}>
